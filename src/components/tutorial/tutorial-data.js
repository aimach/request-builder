const tutorial = [
  ...
  },
  {
    en: {
      ...
      example:
        "Example: there is no body since we're using the GET method. We have 1 params (type) and 2 query (color and limit).",
    },
    fr: {
  ...
  },
  {
    en: {
      title: "Client Side",
      firstParagraph:
        "In the box, you can see the method and the address you'll use in fetch, axios, or Postman. If you hover over the address, the different elements are highlighted, and you see their counterparts on the server side. If you have a body, it will be displayed below the box.",
      example:
        "Example : we can see that the request's adress has been generated by the data filled in the form. There's no body as we're using the GET method.",
    },
    fr: {
      title: "Coté client",
      firstParagraph:
