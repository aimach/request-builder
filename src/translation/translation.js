const translation = {
  en: {
    ...
    backQuery: "req.query you get from client request",
    close: "Close",
    made: "Made with ❤️ by",
    for: "for",
  ...
  fr: {
    ...
    backParams: "req.params que tu reçois depuis la requête du client",
    backQuery: "req.query que tu reçois depuis la requête du client",
    close: "Fermer",
