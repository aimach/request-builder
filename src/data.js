export const infos = [
  ...
  {
    name: "path",
    en: "The path identifies the resource on the server. When combined with the value of the 'host' header, it forms the complete URL of the request. For example, if you have a path '/api/users', and the host is 'www.example.com', the complete URI of the request will be 'http://www.example.com/api/users'.",
    fr: "Le chemin identifie la ressource sur le serveur. Combiné avec la valeur de l'en-tête 'host', il forme l'URI complète de la requête. Par exemple, si tu as un chemin '/api/users', et que le host est 'www.example.com', l'URI complète de la requête sera 'http://www.example.com/api/users'",
  },
  {
    name: "body",
...
export const translation = {
  en: {
    ...
    intro:
      "Welcome to Request Builder, a tool to assist you in constructing your HTTP requests and gaining a better understanding of their structure in Express. First, fill out the form below, then explore your request and its associated elements.",
    clear: "Clear",
    add: "Add",
    host: "Host",
    backPort: "Backend Port",
    frontPort: "Frontend Port",
    method: "Method",
    path: "Path",
    body: "Body",
    params: "Params",
    ...
    key: "key",
    value: "value",
    frontIntro: "The request you sent with fetch or axios",
  ...
  fr: {
    ...
    intro:
      "Bienvenue sur Request builder, un outil pour t'aider à construire tes requêtes HTTP et à mieux comprendre leur structure dans Express. Tout d'abord, remplis le formulaire ci-dessous puis découvre ta requête et les éléments associés.",
    clear: "Effacer",
    add: "Ajouter",
    host: "Host",
    backPort: "Port du backend",
    frontPort: "Port du frontend",
    method: "Méthode",
    path: "Chemin",
    body: "Body",
    params: "Params",
    ...
    key: "clé",
    value: "valeur",
    frontIntro: "La requête que tu envoies avec fetch ou axios",
